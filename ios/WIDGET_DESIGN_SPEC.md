...
Live Activities 用于在灵动岛和锁屏界面实时展示即将开始的课程信息，帮助用户快速了解即将到来的课程详情，帮助其准时到达正确的教室进行课前准备。
...
2. 课程开始后或用户点击“我已到达”自动结束 Live Activity

**设置位置：**
- 应用内：设置 → 小组件与实时活动 → 课前实时活动
- 开关：默认**开启**
- 提前时间：可调节
...
**Leading（左上）：**
- color bar + 课程名称（完整）(见@ScheduleWidget/小组件设计)
- 教室 + 教师
