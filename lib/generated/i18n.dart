...
class S implements WidgetsLocalizations {
  ...
  String get export_classtable_subtitle => "导出当前课表为二维码/链接\n使用公共服务 file.io";
  String get export_classtable_title => "导出当前课表";
  ...
  String get import_from_qrcode_subtitle => "从他人分享的二维码导入课表";
  String get import_from_qrcode_title => "二维码导入课表";
  ...
  String get import_or_export_title => "导入/导出课表";
  String get import_success_toast => "导入完成";
  String get import_title => "导入课程表";
  String get importing_toast => "导入中 请稍后";
  ...
  String get month => "月";
  String get more_settings_subtitle => "课表样式设置，高级设置与试验功能";
  ...
  String get show_date_subtitle => "显示当前周的日期";
  String get show_date_title => "显示日期";
  String get show_month_subtitle => "在课表的左上角显示当前月份";
  String get show_month_title => "显示月份";
